...
class AyaVisionAPI(ls.LitAPI):
    """
    AyaVisionAPI is a subclass of ls.LitAPI that provides methods for the Aya Vision model for vision-language understanding.
    ...
    def setup(self, device):
        """
        Sets up the model, processor and a text streamer for the Aya Vision model.
        """
        model_id = "CohereForAI/aya-vision-8b"
        self.device = device
        self.processor = AutoProcessor.from_pretrained(
            model_id, token=access_token, use_fast=True
        )
        self.model = (
...
if __name__ == "__main__":
    # Create an instance of the AyaVisionAPI class and run the server
    api = AyaVisionAPI()
